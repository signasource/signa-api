        ...
        List<NotificationTemplate> defaults =
                List.of(
                        ...
                        template(
                                ...
                                NotificationScope.INDIVIDUAL,
                                true,
                                "Tu practica diaria te espera",
                                "Unos minutos al dia hacen la diferencia. Vamos a practicar!"),
                        template(
                                NotificationCode.DAILY_REMINDER,
                                NotificationScope.INDIVIDUAL,
                                true,
                        ...
                        template(
                                ...
                                NotificationScope.INDIVIDUAL,
                                true,
                                "{{streak}} dias y contando!",
                                "Tu dedicacion esta dando frutos. No pares ahora!"),
                        template(
                                NotificationCode.NEW_COURSE_AVAILABLE,
                                NotificationScope.INDIVIDUAL,
                                false,
                                "Nuevo curso disponible",
                                "Ya podes empezar {{course}}."),
                        template(
