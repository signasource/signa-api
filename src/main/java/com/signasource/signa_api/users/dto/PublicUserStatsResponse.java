...
public record PublicUserStatsResponse(
        int currentStreak, int longestStreak, long totalXp, int weeklyXp, int weeklyRank, int learnedSignsCount) {

    public static final PublicUserStatsResponse EMPTY = new PublicUserStatsResponse(0, 0, 0L, 0, 0, 0);
