...
class JwtAuthFilterTest {
	...
	@BeforeEach
	void setUp() {
		User testUser = User.builder().email(EMAIL).name("Test User").passwordHash("hashed_password_123")
	...
	@Test
	void testFilterSkipsAuthenticationWhenContextAlreadyAuthenticated() throws ServletException, IOException {
