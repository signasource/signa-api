...
class LessonControllerTest {
	...
	void testGetLessonContent() {
		// Arrange
		LessonBlockResponse blockResponse = new LessonBlockResponse(UUID.randomUUID(), "VIDEO", 1,
				"{\"url\":\"video.mp4\"}", 20, false);

		LessonDetailResponse mockDetail = new LessonDetailResponse(lessonId, "Aprende la letra A", "Desc", 1,
				List.of(blockResponse));
